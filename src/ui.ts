namespace game{
	...
	export class _GamePage1 extends ui.Container {
		...
		private static _childs = [
			{ class: "UIStage", id: "game", left:0, width:710, top:0, height:1280, _childs:[
				...
				{ type: "Image", src:"game/hole", anchorX:0.5, anchorY:0.5, x:318, y:578.5, width:246, height:119 },
			] },
	...
	export class _GamePage2 extends ui.Container {
		...
		private static _childs = [
			{ class: "UIStage", id: "game", left:0, width:710, top:0, height:1280, _childs:[
				{ type: "Image", src:"image/bg" },
				{ type: "Image", src:"game/wall", angle:32, x:-50, y:175, anchorX:0.5, anchorY:0.5 },
				{ type: "Image", src:"game/wall", angle:-33, x:738, y:350, anchorX:0.5, anchorY:0.5 },
				{ type: "Image", src:"game/wall", angle:-33, x:-50, y:950, anchorX:0.5, anchorY:0.5 },
				{ type: "Image", src:"game/wall", angle:32, x:738, y:1125, anchorX:0.5, anchorY:0.5 },
				{ type: "Image", src:"game/hole", anchorX:0.5, anchorY:0.5, x:318, y:635.5, width:246, height:119 },
			] },
			{ class: "Control", id: "touch", width:"100%", height:"100%" },
			{ class: "Group", id: "intro", width:"100%", height:"100%", _childs:[
				{ class: "RectFill", color:"#000", opacity:0.3, width:"100%", height:"100%" },
	...
	export class _GamePage3 extends ui.Container {
		...
		private static _childs = [
			{ class: "UIStage", id: "game", left:0, width:710, top:0, height:1280, _childs:[
				{ type: "Image", src:"image/bg" },
				{ type: "Image", src:"game/wall2", anchorX:0.5, anchorY:0.5, x:122, y:300 },
				{ type: "Image", src:"game/wall2", anchorX:0.5, anchorY:0.5, x:588, y:300 },
				{ type: "Image", src:"game/wall", angle:32, x:738, y:750, anchorX:0.5, anchorY:0.5 },
				{ type: "Image", src:"game/wall", angle:32, x:738, y:1125, anchorX:0.5, anchorY:0.5 },
				{ type: "Image", src:"game/wall", angle:-33, x:-50, y:937.5, anchorX:0.5, anchorY:0.5 },
				{ type: "Image", src:"game/hole", anchorX:0.5, anchorY:0.5, x:318, y:450.5, width:246, height:119 },
			] },
			{ class: "Control", id: "touch", width:"100%", height:"100%" },
			{ class: "Group", id: "intro", width:"100%", height:"100%", _childs:[
				{ class: "RectFill", color:"#000", opacity:0.3, width:"100%", height:"100%" },
	...
	export class _GamePage4 extends ui.Container {
		static ClassName = "game.GamePage4";
		static instance: game.GamePage4;
		private static _childs = [
			{ class: "UIStage", id: "game", left:0, width:710, top:0, height:1280, _childs:[
				{ type: "Image", src:"image/bg" },
				{ type: "Image", src:"game/wall2", anchorX:0.5, anchorY:0.5, x:122, y:450.5 },
				{ type: "Image", src:"game/wall2", anchorX:0.5, anchorY:0.5, x:588, y:920.5 },
				{ type: "Image", src:"game/wall2", angle:90, anchorX:0.5, anchorY:0.5, x:242, y:920.5 },
				{ type: "Image", src:"game/wall2", angle:90, anchorX:0.5, anchorY:0.5, x:468, y:450.5 },
				{ type: "Image", src:"game/hole", anchorX:0.5, anchorY:0.5, x:318, y:578.5, width:246, height:119 },
			] },
			{ class: "Control", id: "touch", width:"100%", height:"100%" },
			{ class: "Group", id: "intro", width:"100%", height:"100%", _childs:[
		...
		constructor(parent: ui.Container, template?:ui.Template){
			...
			if(template){
				...
				this._createChilds(_GamePage4._childs);
			const n = this.namedChilds;
			this.width = "100%";
			this.height = "100%";
		}
	...
	ez.initCall(() => { ui.initUIClass(game.GamePage4, ui.Container) });
	...
	export class ResultPage extends ui.Container {
		...
		private static _childs = [
			...
			{ class: "Group", top:840, bottom:0, width:"100%", _childs:[
				{ class: "game.Button", id: "replay", label:"下一关", style:"purple", x:"50%", width:195, y:"50%", height:70 },
			] },
