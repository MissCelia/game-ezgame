...
(function (game) {
    ...
    class _GamePage1 extends ui.Container {
        constructor(parent, template) {
            super(parent);
            if (template) {
                this._createChilds(template.childs);
    ...
    class _GamePage2 extends ui.Container {
        constructor(parent, template) {
            super(parent);
            if (template) {
                this._createChilds(template.childs);
    ...
    class _GamePage3 extends ui.Container {
        constructor(parent, template) {
            super(parent);
            if (template) {
                this._createChilds(template.childs);
    ...
    class _GamePage4 extends ui.Container {
        constructor(parent, template) {
            super(parent);
            if (template) {
                this._createChilds(template.childs);
    ...
    _GamePage4.ClassName = "game.GamePage4";
    _GamePage4._childs = [
        { class: "UIStage", id: "game", left: 0, width: 710, top: 0, height: 1280, _childs: [
                { type: "Image", src: "image/bg" },
...
(function (gameUtils) {
    ...
    function showResult(ctx, nextStage) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            ctx.dispose();
            var data = yield commitScore(totalScore);
        });
    }
...
(function (game) {
    ...
    var launchResovle = null;
    class GamePage2 extends game._GamePage2 {
        constructor(parent) {
            super(parent);
            var lastLine = lines[lines.length - 1];
            lastLine[0].y = lastLine[1].y = parent.getBound().height - 0;
